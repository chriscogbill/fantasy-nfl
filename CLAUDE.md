...
- **Key tables**: players, player_stats, player_current_prices, player_price_history, player_scores (view), teams, rosters, transfers, leagues, league_entries, nfl_fixtures, scoring, scoring_sections, users, app_settings, lineup_deadlines (game rules — $100M budget, 15 spots, position minimums — are hardcoded in the PL/pgSQL functions + frontend; the old roster_constraints table was dead and dropped July 2026)
